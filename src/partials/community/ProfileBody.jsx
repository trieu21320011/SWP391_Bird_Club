      ...
      <div className="relative px-4 sm:px-6 pb-8">
        ...
        <div className="-mt-16 mb-6 sm:mb-3">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
            ...
            <div className="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
              <img className="rounded-full border-4 border-white" src="https://scontent.fsgn2-9.fna.fbcdn.net/v/t39.30808-6/341868164_781913886496459_5820586788419205532_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=btdKADEdzg0AX_iO3E8&_nc_ht=scontent.fsgn2-9.fna&oh=00_AfCVwrnzrAXM8eH9dCGqyIJJepRshEf_TRwbQ2GhBRqHyw&oe=646C7D59" width="128" height="128" alt="Avatar" />
            </div>
        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="inline-flex items-start mb-2">
            <h1 className="text-2xl text-slate-800 font-bold">Hoàng Trung Thông ( Thông Soái Ca)</h1>
          ...
          {/* Bio */}
          <div className="text-sm mb-3">Những thằng khác ngại tán em, tại ngán anh</div>
          {/* Meta */}
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            <div className="flex items-center">
              ...
              <span className="text-sm font-medium whitespace-nowrap text-slate-500 ml-2">Ho Chi Minh, IT</span>
            </div>
            <div className="flex items-center">
              <svg className="w-4 h-4 fill-current shrink-0 text-slate-400" viewBox="0 0 16 16">
          ...
          <div className="space-y-5 mb-8 xl:mb-0">
            ...
            <div>
              ...
              <div className="text-sm space-y-2">
                <p>
                Hello! I'm Thong, an avid bird enthusiast and the admin of the Bird Club. With a deep passion for ornithology since childhood, I joined the club to connect with the community and share my love for birds. As an admin, I provide guidance on bird care, from selecting suitable species to addressing health issues. Together, let's nurture a vibrant bird-keeping community!
                </p>
            ...
            <div className="bg-slate-50 p-4 rounded border border-slate-200">
              <div className="text-xs font-semibold text-slate-400 uppercase mb-4">Your Blogs</div>
